  ...
  return (
    <div>
      <Accordion>
        ...
        >
          <div className='flex items-center gap-5 text-[1.1rem] max-sm:gap-3 max-sm:text-sm'><Image src={certification} alt='certification' width={60} className='w-10'/>BACK-END TECHNOLOGIES</div>
        </AccordionSummary>
        <AccordionDetails>
